...
import org.openqa.selenium.support.ui.WebDriverWait;
    ...
    class TestClass1 implements Runnable {
        public void run() {
            ...
            capsHashtable.put("build", "Sample Build On IPhone");
            capsHashtable.put("name", "Thread 1");
            CrossBrowserSample r1 = new CrossBrowserSample();
    ...
    class TestClass2 implements Runnable {
        public void run() {
            ...
            capsHashtable.put("build", "Sample Build On Google Pixel");
            capsHashtable.put("name", "Thread 2");
            CrossBrowserSample r2 = new CrossBrowserSample();
    ...
    class TestClass3 implements Runnable {
        public void run() {
            ...
            capsHashtable.put("build", "Sample Build  On Safari");
            capsHashtable.put("name", "Thread 3");
            CrossBrowserSample r3 = new CrossBrowserSample();
            r3.executeTest(capsHashtable);
        }
    }
    public class CrossBrowserSample {
        public static final String USERNAME = "kousalyasarathy1";
        public static final String AUTOMATE_KEY = "djZh2ghLVGQAjreuvt1Q";
